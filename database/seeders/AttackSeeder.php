...
class AttackSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $attacksData = [
            ...
            [
                'name' => 'Find a Friend',
                'description' => 'Put 1 random Grass pokemon from your deck into your hand.',
                'DMG' => '',
            ],
            [
                'name' => 'Bug Bite',
            ...
            [
                'name' => 'Growth Spurt',
                'description' => 'Take a Grass Energy from your Energy Zone and attach it to this Pokemon',
                'DMG' => '',
            ],
            [
                'name' => 'Psychic',
            ...
            [
                'name' => 'Energy Whip',
                'description' => 'If this pokemon has at least 3 extra Grass Energy attached, this attack does 70 more damage.',
                'DMG' => '20+',
            ],
            [
                'name' => 'Ember',
